...
namespace DennisDigital\Behat\DefaultContent\Context;
...
class DefaultContentContext implements DrupalAwareInterface {
   ...
   * @beforeTermCreate
   */
  public function generateDefaultContent(EntityScope $scope) {
    $entity = $scope->getEntity();
